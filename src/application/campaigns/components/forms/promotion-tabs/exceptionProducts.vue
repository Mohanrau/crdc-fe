<template>
    <div class="exception-products-tab">
        <div class="row">
            <div class="col-12">
                <q-field
                        helper="*"
                >
                    <table class="q-table-html bordered cell-separator full-width mt-10">
                        ...
                        <tr v-for="(item, index) in esacPromotionData.exception_products_and_kittings">
    ...
    methods: {
      ...
      addRow () {
        if (this.adderRow.product_id > 0 || this.adderRow.kitting_id > 0) {
          ...
          this.esacPromotionData.exception_products_and_kittings.forEach(element => {
          ...
          if(duplicated) {
            ...
            this.esacPromotionData.exception_products_and_kittings.push(Vue.util.extend({}, JSON.parse(JSON.stringify(this.adderRow))))
            // Reset adderRow
            let newRow = initializeAdderRow()
      ...
      removeRow (index) {
        Vue.delete(this.esacPromotionData.exception_products_and_kittings, index)
      }
    }
  }
</script>