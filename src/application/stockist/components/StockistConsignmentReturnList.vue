          ...
          <div class="row gutter-sm generic-margin">
            ...
            <div class="col-lg-2">
              <q-select
                ...
                :options="masterDataOptionsCreator(this.$const.masterKey.CONSIGNMENT_RETURN_STATUS)"
                filter
                :disable="disable"
                color="black"
                clearable
...
<script>
  ...
  export default {
    ...
    data: function () {
      return {
        ...
        columns: [
          ...
          {
            label: this.$t('stockist.DTableLabel.consignmentReturnNote'),
          ...
          {
            label: this.$t('stockist.DTableLabel.returnAmount'),
            name: 'total_gmp.name',
            field: 'total_gmp',
            align: 'center',
            sort: false
          ...
          {
            label: this.$t('stockist.DTableLabel.verificationStatus'),
            name: 'status.title',
            field: 'status',
            align: 'center',
            sort: false,
          ...
          {
            label: this.$t('stockist.DTableLabel.verifiedBy'),
            name: 'action_by.name',
            field: 'action_by',
            align: 'center',
            sort: false,
          ...
          {
            label: this.$t('stockist.DTableLabel.verificationDate'),
            name: 'updated_at',
            field: 'updated_at',
            align: 'center',
            sort: false
          ...
          {
            label: this.$t('stockist.DTableLabel.whReceiveStatus'),
            name: 'wh_receiving_status',
            field: 'wh_receiving_status',
            align: 'center',
            sort: false,
            format (element) {
          ...
          {
            label: this.$t('stockist.DTableLabel.whReceivedBy'),
            name: 'wh_receive_by',
            field: 'wh_receive_by',
            align: 'center',
            sort: false,
          ...
          {
            label: this.$t('stockist.DTableLabel.whReceivedAt'),
            name: 'wh_receive_at',
            field: 'wh_receive_at',
            align: 'center',
            sort: false,
    ...
    mounted () {
      this.master.keys = [
        'stockist_type',
        this.$const.masterKey.CONSIGNMENT_RETURN_STATUS
      ]
      ...
      routePage (data) {
        ...
        if (data.stockistOrderID !== '') {
          this.$router.push({
            ...
            params: {consignmentType: 'return', consignmentID: data.stockistOrderID}
          })
        } else {
          this.$router.push({
            name: 'New Stockist Consignment Return',
            params: {consignmentType: 'return'}
          })
        }
      },
