<template>
    <div class="general-page-holder relative-position">
        <basic-form formName="RentalSalesForm"
                    :formTitle="$t('sales.newSales.title')"
                    :backgroudColor="false"
                    v-bind:formFieldData="salesData"
                    urlResetPathName="New Rental Sales & Rental Order History"
                    formAction="rentalSalesOrderAction"
                                    ...
                                    <q-card color="white" class="full-height">
                                        <q-card-main class="text-black">
                                            <div class="row items-start">
                                                <div class="col-lg-6 personal-data-holder">
                                                    <q-list no-border
                                                        ...
                                                        <q-item tag="label" multiline
                                                                v-if="typeof memberDetails.upline.name !== 'undefined' && memberDetails.upline.name !== null && this.salesData.sponsor_member_id !== ''">
                                                            <q-item-main>
                                                        ...
                                                        <q-item-separator
                                                                v-if="this.salesData.sponsor_member_id ===  this.salesData.downline_member_id"/>
                                                                ...
                                                                <q-item-tile right>
                                                                    <q-input v-model.trim="terms"
                                                                        ...
                                                                        <q-autocomplete
                                                                                ...
                                                                                @selected="(item) => selected(item, 'terms')"
                                                                        />
                                                                    </q-input>
                                                                </q-item-tile>
                                                            </q-item-main>
                                                            ...
                                                            <q-item-main>
                                                                ...
                                                                <q-item-tile sublabel>
                                                                    <q-select
                                                                            ...
                                                                            @input="shippingSectionRestrictionStatus()"
                                                            ...
                                                            <q-item-main>
                                                                ...
                                                                <q-item-tile sublabel>
                                                                    <q-select
                                                                            ...
                                                                            clearable
                                                                            :disable="lockSalesOrder && (isSaleOrderStatusCancelled || isSaleOrderStatusComplete)"
                                              ...
                                              <div class="col-lg-12 documents-data-holder" v-if="!(isProcessingForm || isProcessingCart || isProcessingSection || isProcessingTable)">
                                                <div class="row">
                                                  <div class="col-lg-auto col-sm-12 document-data-holder">
                                                    <div class="row col">
                                                      <q-list no-border class="fit">
                                                        <q-item tag="label">
                                                          <q-item-main>
                                                            <q-item-tile sublabel>Sale Doc.No</q-item-tile>
                                                            <q-item-tile sublabel>
                                                              <q-chip class="cursor-pointer fit" square small
                                                                      v-if="salesData.document_number && ( !isSaleOrderStatusCancelled && isSaleOrderStatusPreOrder)"
                                                                      color="primary"
                                                                      icon="launch"
                                                              ...
                                                              <q-chip square small
                                                                      v-else-if="salesData.document_number && isSaleOrderStatusComplete"
                                                                      class="fit">
                                                                {{ salesData.document_number }}
                                                              </q-chip>
                                                              <q-chip class="fit" square small v-else="">
                                                                -- N/A --
                                                              </q-chip>
                                                            </q-item-tile>
                                                          </q-item-main>
                                                  ...
                                                  <div class="col-lg-auto col-sm-12 document-data-holder">
                                                    <div class="row">
                                                      <q-list no-border class="fit">
                                                        <q-item tag="div" data-schema="invoice|download" multiline
                                                                :class="{'disabled' : !$can($apply('invoice|download'))}">
                                                          <q-item-main>
                                                            <q-item-tile sublabel>Tax invoice</q-item-tile>
                                                            <q-item-tile sublabel>
                                                              <q-chip class="cursor-pointer fit" square small
                                                                      color="primary"
                                                                      icon="launch"
                                                  ...
                                                  <div class="col-lg-auto col-sm-12 document-data-holder">
                                                    <div class="row">
                                                      <!--Todo add rnp: this button follow sales cancellation create -->
                                                      <q-list no-border class="fit">
                                                        <q-item tag="div" data-schema="sales|cancel" multiline
                                                                :class="{'disabled' : !$can($apply('sales|cancel'))}">
                                                          <q-item-main>
                                                            ...
                                                            <q-item-tile sublabel>
                                                              <q-chip class="cursor-pointer fit" square small
                                                                      ...
                                                                      color="negative"
                                                                      icon="delete_forever"
                                                                      @click="$can($apply('')) ? cancelPreOrder() : ''">
                                                                {{ $t('sales.cancelByStatus.label', {status:  getCurrentOrderStatus}) }}
                                                              </q-chip>
                                                              <q-chip class="fit" square small v-else="" :color="isSaleOrderStatusComplete ? 'positive' : ''">
                                            ...
                                            <div class="row full-height">
                                                <div class="col-4">
                                                    <div class="row no-margin content-stretch cv-boxes full-height">
                                                        ...
                                                        <div class="col-12 pd-10">
                                                            <span class="text-grey-5">Total Qualified Campaign CV</span>
                                                            <h5>{{ salesData.cvs.total_qualified_cv }}</h5>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-8 pd-10">
                                                    <q-list no-border dense>
                                                        <q-item tag="label" multiline>
                                                            <q-item-main>
                                      ...
                                      <q-tabs inverted two-lines no-pane-border color="grey-7" align="left"
                                        ...
                                        <q-tab default name="corporate_sales" :alert="$v.salesData.corporate_sales !== undefined && $v.salesData.corporate_sales !== null ? $v.salesData.corporate_sales.$error : false"
                                          ...
                                          <q-tab name="shipping" slot="title"
                                                 ...
                                                 label="Shipping"/>
                                          <q-tab name="payments" :disable="lockPayment" slot="title" label="Payments"/>
                                          <q-tab name="workflow" slot="title" v-if="salesData.workflow !== undefined && salesData.workflow !== null && !salesData.workflow.isArray && !isSaleOrderStatusVoid && !isSaleOrderStatusRejected" label="Workflow"/>
                                          <!-- Tab Content -->
                                          ...
                                          <q-tab-pane name="payments" class="bg-white sales-items">
                                              ...
                                              <payment-tab v-bind:paymentData="salesData"
                                                           ...
                                                           :excludePaymentMode="['AEON', 'E-Wallet', 'House Cheque', 'Discount Voucher', 'EPP (Moto)', 'EPP (Terminal)', 'Credit Card', 'Credit Card (Mega)', 'MPOS']"
                                              ></payment-tab>
                                              <!-- Payments Content End -->
                                          </q-tab-pane>
                                        <q-tab-pane name="workflow" v-if="salesData.workflow !== undefined && salesData.workflow !== undefined && !salesData.workflow.isArray" class="bg-white sales-items">
                                          <!-- Workflow Content-->
                                          <workflow-tab
                                            v-bind:rentalSalesOrder="salesData"
                                            :isNewRequest="lockSalesOrder"
                                            :manipulateSaveData="manipulateSaveData"
                                          ></workflow-tab>
                                          <!-- Payments Content End -->
                                        </q-tab-pane>
                                      </q-tabs>
...
<script>
  ...
  import { WorkflowTab } from 'src/application/sales/components/rental-sales-tabs/index'
  import { ItemsTab, PaymentTab, ShippingTab, CorporateDetail } from 'src/application/global/components/common/shared-tabs'
  ...
  export default {
    ...
    mounted () {
      this.master.keys = [this.$const.masterKey.SALE_TYPES, this.$const.masterKey.SALE_ORDER_STATUS]
      this.initSetupArea()
    },
    computed: {
      ...mapState({
    ...
    methods: {
        ...
        this.getCountryRelationAction(query1).then(() => {
          if (this.locationsOptionsByCountry.length > 0) {
            ...
            if (!this.lockSalesOrder) {
              this.salesData.location_id = this.locationsOptionsByCountry[0].value
      ...
      invalidRequest () {
        ...
        setTimeout(() => {
          ...
          this.$router.push({name: 'New Rental Sales & Rental Order History'})
        }, 3000)
      },
      /**
       * Add items to cart
              ...
              this.getProductByIdAction(query1).then((res) => {
                ...
                Promise.all([reConstructPromise]).then(() => {
                  ...
                  Promise.all([assignTransactionTypePromise]).then(() => {
                    let getMasterDataOptionsPromise = Promise.resolve(this.masterDataOptionsCreator(this.$const.masterKey.SALE_TYPES))
                    Promise.all([getMasterDataOptionsPromise]).then((res) => {
                      let saleTypes = res
                      if (saleTypes[0].length > 0) {
                        let rentalData = saleTypes[0].find((data) => {
                          return data.label.toLowerCase() === this.$const.masterKey.RENTAL.toLowerCase()
                        })
                        if (rentalData !== undefined && rentalData !== null) {
                          this.salesData.products[this.salesData.products.length - 1].transaction_type = rentalData.value
                        }
                      }
                    })
                ...
                Promise.all([reConstructPromise]).then(() => {
                  ...
                  Promise.all([assignTransactionTypePromise]).then(() => {
                    ...
                    Promise.all([getMasterDataOptionsPromise]).then((res) => {
                      ...
                      if (rentalData !== undefined && rentalData !== null) {
                        this.salesData.kittings[this.salesData.kittings.length - 1].transaction_type = rentalData.value
                      }
                    })
      ...
      manipulateSaveData (operation) {
        ...
        if (typeof this.salesDetails !== 'undefined' && Object.keys(this.salesDetails).length > 0) {
          ...
          if (this.salesData.workflow !== undefined && this.salesData.workflow !== null && this.salesData.workflow.workflow !== undefined && this.salesData.workflow.workflow !== null) {
            this.salesData.workflow = this.salesData.workflow.workflow
          }
      ...
      shippingSectionRestrictionStatus () {
        ...
        // if (typeof item !== 'undefined' && !this.lockSalesOrder) {
        //   if (item.type_id === 3) {
      ...
      selected (item, field) {
        ...
        let data = {upline_id: this.memberDetails.upline.user_id, user_id: item.value}
        this.getMember(data)
        this.salesData.downline_member_id = item.value
